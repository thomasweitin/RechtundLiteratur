...
### Fuehrt stilometrische Analysen mit mehreren Parametersettings durch
### Abb. 3 Stilometrisches Clustering Gartenlaube vs. Pitaval (Auswahl)
### Siehe hierzu: Weitin, T. (2021). Stilometrie. 
### In: Digitale Literaturgeschichte. Digitale Literaturwissenschaft. 
### https://doi.org/10.1007/978-3-662-63663-3_4
#------------------------------------------------------------------------------#
...
###
### corpora
###     |_Vergleich_Pitaval-Gartenlaube
...
path_results <- paste0(path_results, "\\Stilometrie")
...
# angelegt werden.
# z.B.:
# param_500MFW_cosine <- list(500, FALSE, "cosineDelta", 1)
# param_1000MFW_cosine <- list(1000, FALSE, "cosineDelta", 1)
...
# komplette Pfade zu den Korpora, die bearbeitet werden sollen
corpus_1 <- paste0(path_corpora, "\\Vergleich_Pitaval-Gartenlaube")
#corpus_2 <- paste0(path_corpora, "\\Vergleich_Pitaval-Gartenlaube-Novellenschatz")

# LISTE VON KORPORA
# Zugriff mit Index: corpora[1]

corpora <- list(corpus_1)
